# Korea AI Trader V0.7.1 Auto Sidecar Fix
...
- pykrx 지수 코드 오류 `KeyError: '지수명'` 방어
- KOSPI200 지수 코드 자동 탐색
- 실패 시 KOSPI 지수 `1001` fallback
- 지수 데이터 오류가 나도 서버가 죽지 않도록 처리

추천 변수:

```txt
KOSPI200_INDEX_CODE=auto
```
